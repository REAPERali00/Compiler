...
// typedef enum ArithmeticOperators { OP_ADD, OP_SUB, OP_MUL, OP_DIV }
// AriOperator; typedef enum RelationalOperators { OP_EQ, OP_NE, OP_GT, OP_LT }
// RelOperator; typedef enum LogicalOperators { OP_AND, OP_OR, OP_NOT }
// LogOperator; typedef enum SourceEndOfFile { SEOF_0, SEOF_255 } EofOperator;
//

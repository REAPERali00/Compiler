...
nag_void matchToken(nag_intg tokenCode, nag_intg tokenAttribute) {
	nag_intg matchFlag = 1;
...
nag_void syncErrorHandler(nag_intg syncTokenCode) {
	printError();
	syntaxErrorNumber++;
 ...
 * FIRST(<opt_varlist_declarations>) = { e, KW_T (KW_int), KW_T (KW_float),KW_T (KW_char), KW_T (KW_string)}.
 ***********************************************************
 */
 ...
 * FIRST(<varlist_declarations>) = { e, KW_T (KW_int), KW_T (KW_float),KW_T (KW_char), KW_T (KW_string)}.
 ***********************************************************
 */
 ...
 * BNF: <varlist_declarations> -> <varlist_declarationsPrime> -> <varlist_declaration> <varlist_declarationsPrime> | ϵ
 * FIRST(<varlist_declarations>) = { e, KW_T (KW_int), KW_T (KW_float),KW_T (KW_char), KW_T (KW_string)}.
 ***********************************************************
 */
...
nag_void varListDeclaration() {
		...
		case KW_char:
			...
			matchToken(CVAR_T, NO_ATTR);
			matchToken(EOS_T, NO_ATTR);
			printf("%s%s\n", STR_LANGNAME, ": Character Variable List parsed");
			break;
		case KW_string:
			matchToken(KW_T, KW_string);
			matchToken(SVAR_T, NO_ATTR);
			matchToken(EOS_T, NO_ATTR);

...
//  *Expression) is recognized and the appropriate function is called (related
//  to *final states in the Transition Diagram).
//  ***********************************************************
//  */
//
...
//       /*
//       ------------------------------------------------------------------------
//               Part 2: Implementation of Finite State Machine (DFA) or
//               Transition
...
//         The filename and linenum listed in the message are the source file
//         name and line number where the assert macro appears.
//         - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
//         - If you place the #define NDEBUG directive ("no debugging") in the
//         source code before the #include <assert.h> directive, the effect is
//         to comment out the assert statement.
//         - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
//   readerGetPosWrte(stringLiteralTable); for (i = 1; i < len - 1; i++) {
//     if (lexeme[i] == '\n')
//       line++;
//   }
...
//       printf("%s%s%s%d%s", "Token[", tokenStrTable[cont],
//              "]=", scData.scanHistogram[cont], "\n");
//   }
//   printf("----------------------------------\n");
// }
//
